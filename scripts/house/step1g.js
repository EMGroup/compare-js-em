...
house.prototype.drawables = function(Triangle) {
	return [this.houseBlock(), this.roof(Triangle)];
}

/* Usage */
/* Case 1*/
myhouse_inst = new house(100,100);
myhouse = myhouse_inst.drawables(Triangle);
...
/* Case 7*/
myhouse_inst = new house(100,100);
myhouse = myhouse_inst.drawables(OutlineTriangle);
