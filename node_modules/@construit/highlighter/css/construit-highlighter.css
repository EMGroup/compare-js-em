...
span.eden-comment-ul {
	white-space: normal;
}

span.eden-comment-ul:before {
	content: "\f111";
	color: #2b4957;
	margin-left: 10px;
	margin-right: 15px;
...
div.eden-comment-h1 {
	color: #666;
	font-size: 2em;  /* "Source Sans Pro",Arial,Helvetica,sans-serif;*/
	font-weight: bold;
	width: 100%;
...
div.eden-comment-h2 {
	color: #666;
	font-size: 1.7em /*"Source Sans Pro",Arial,Helvetica,sans-serif;*/
}
